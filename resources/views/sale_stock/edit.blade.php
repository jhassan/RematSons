	...
	<div class="content-box-large">
		...
		<div class="panel-body">
			...
			<fieldset>
				...
				<div class="form-group col-sm-3">
					<label>Date</label>
					<div class="bfh-datepicker" data-name="purchase_date" data-format="d-m-y" data-date="{{ date('Y-m-d', strtotime($master_data->sale_date)) }}">
				...
				<div class="panel-heading">
					<legend>Edit All Sale Items</legend>
				</div>
